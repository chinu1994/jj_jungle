...
class TestUrlRegex(TransactionCase):
    def test_url_regex(self):
        url_www = self.env['jj.social.post']._extract_url_from_message(
        ...
        url_https = self.env['jj.social.post']._extract_url_from_message(
        ...
        url_https_www = self.env['jj.social.post']._extract_url_from_message(
        ...
        no_url = self.env['jj.social.post']._extract_url_from_message(
