...
import { AddSocialStreamDialog } from './jj_jungle_add_stream_modal';
import { NewContentRefreshBanner } from './jj_jungle_stream_post_kanban_refresh_banner';
import { StreamPostDashboard } from './jj_jungle_stream_post_kanban_dashboard';
...
export class StreamPostKanbanController extends KanbanController {
    ...
    setup() {
        ...
        onWillStart(async () => {
            this.isSocialManager = await this.user.hasGroup("JJ_Junglesocial.group_social_manager");
            this.hasAccounts = await this.orm.searchCount('jj.social.account', []) > 0;
...
StreamPostKanbanController.template = 'JJ_Junglesocial.SocialKanbanView';
