...
class JJSocialAccount(models.Model):
    _name = 'jj.social.account'
    _description = 'JJ Social Account'
    ...
    def create(self, vals_list):
        ...
        if all(vals.get('media_id') and vals.get('name') for vals in vals_list):
            ...
            media_all = self.env['jj.social.media'].search([('id', 'in', [vals.get('media_id') for vals in vals_list])])
            media_names = {
        ...
        res = super(JJSocialAccount, self).create(vals_list)
